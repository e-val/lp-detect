function [performance, stability] = train_and_benchmark_neural_network(trainInputs, trainTargets, extractedInputs, extractedTargets, extractedLicensePlateIds, numberOfTimesToTestNetwork, net)
